...
import 'bend-code/src/libraries/types/ResultTypes.sol';
...
contract TestUIPoolLens is TestWithPrepare {
  ...
  function test_Should_GetUserAccountDataForCalculation_Supply() public {
    ...
    (
      ...
      vars1.healthFactor
    ) = tsUIPoolLens.getUserAccountDataForCalculation(address(tsDepositor1), tsCommonPoolId, 1, address(tsWETH), 0);
    ...
    (
      ...
      vars2.healthFactor
    ) = tsUIPoolLens.getUserAccountDataForCalculation(
  ...
  function test_Should_GetUserAccountDataForCalculation_Borrow() public {
    ...
    (
      ...
      vars1.avgLiquidationThreshold,
      vars1.healthFactor
    ) = tsUIPoolLens.getUserAccountDataForCalculation(address(tsBorrower1), tsCommonPoolId, 3, address(tsUSDT), 0);
  ...
  function test_Should_GetIsolateDataList() public {
    ...
    ) = tsUIPoolLens.getIsolateCollateralDataList(tsCommonPoolId, nftAssets, tokenIds, debtAssets);
    ...
    tsUIPoolLens.getIsolateLoanDataList(tsCommonPoolId, nftAssets, tokenIds);

    tsUIPoolLens.getIsolateAuctionDataList(tsCommonPoolId, nftAssets, tokenIds);

    tsUIPoolLens.getERC721TokenDataList(tsCommonPoolId, nftAssets, tokenIds);
  }
}
